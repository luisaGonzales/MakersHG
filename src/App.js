  ...
  return (
    <HashRouter>
      <Switch>
          ...
          <Route exact path="/check" render={() => <Check ageN={age} colorOptions={colorOptions} imgs={imgs} color={color} gender={gender} imgSelected={imgSelected} age={ageTxt} size={size} allImage={allImage} />} />
